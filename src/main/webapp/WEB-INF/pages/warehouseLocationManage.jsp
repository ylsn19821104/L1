...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/resources/easyui/plugins/jquery.edatagrid.js"></script>
...
<br>
<table id="dg" title="仓位明细" style="width:700px;height:250px" toolbar="#toolbar" idField="id" rownumbers="true"
